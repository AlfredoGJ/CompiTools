...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','lex&jackExample.py',59),
  ('statement -> expression','statement',1,'p_statement_expr','lex&jackExample.py',63),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','lex&jackExample.py',67),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','lex&jackExample.py',68),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','lex&jackExample.py',69),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','lex&jackExample.py',70),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','lex&jackExample.py',77),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','lex&jackExample.py',81),
  ('expression -> NUMBER','expression',1,'p_expression_number','lex&jackExample.py',85),
  ('expression -> NAME','expression',1,'p_expression_name','lex&jackExample.py',89),
]
